...
- **Live preview**: the product photo is re-framed in CSS for every choice — true proportions of the chosen size, a white mat exactly as wide as Prodigi's mount window, the frame colour and depth, a canvas edge for gallery wraps, a float gap for float frames. No generated images; click the preview to see the plain photo gallery. Setting: *Live preview*.
